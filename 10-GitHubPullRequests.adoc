...
For example, instead of running `git clone https://github.com/MikeMcQuaid/GitInPracticeRedux` you could instead just run `gh clone GitInPractice/GitInPracticeRedux` to perform the same action of cloning a GitHub repository to your local machine.
