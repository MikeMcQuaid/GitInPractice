...
//(TP)-Same comment as for 'git show'
...
//(TP)-Should either be 'did:' below or change to 'did :' above.
...
//(TP)-Is it worth mentioning that '-s' takes precedens over '-e', e.g. no email/name is shown.
