...
large ones are covered in Section 1.5.1.
...
_diffstat_ or _word diff_. These terms will be explained in Section 1.6.4.
...
may want to rewrite history. In Chapter 6 we'll learn how to rewrite history
and the cases where it is useful and safe to do so.
