...
//(TP)-Should it be GitHub Flow in both lines below or only Git Flow in the first? Reading on, both I guess. What confused me was that Git Flow was mentioned first, but GitHub flow was described first.
