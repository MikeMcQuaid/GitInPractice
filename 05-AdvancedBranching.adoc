...
//(TP)-Can 'fast-forward merges' be explained in more detail? I do not think it is obvious what 'part' of the below signifies a 'fast-forward' merge. Is it all forced creations?
