...
In Chapter 7 you learnt about configuring Git for maximum productivity. I've been using Git as my main version control system for a pretty long time at this point so have my Git configuration well optimized.
