...
// BEN: usual Manning style is just "In this chapter" and then the bullets. (previous paragraph could go under the bullets)
...
* "Rebase instructions (3)" shows the instructions involved in solving the rebase conflict. There are three suggested flags:
  ...
  `git rebase --abort`::
    ...
    // BEN: Manning doesn't generally do definition lists like this; our usual format is a bulleted list like * TERM--This means...
